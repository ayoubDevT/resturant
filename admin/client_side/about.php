...
<?php include 'header.php'; ?>
	...
	<!-- Title Page -->
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(images/ian-schneider-66374-unsplash.jpg);">
			...
			<div class="row p-t-170">
				<div class="col-md-6 p-b-30">
					<div class="wrap-pic-romantic size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="images/kobby-mendez-1391811-unsplash.jpg" alt="IMG-OUR">
					</div>
				</div>
	...
	<!-- Banner -->
	<div class="parallax0 parallax100" style="background-image: url(images/nong-vang-577609-unsplash.jpg);">
		...
		<div class="container t-center">
			...
			<div class="row">
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="images/avatar/avatar-01.jpg" alt="IGM-AVATAR"></a>
						</div>
				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="images/avatar/avatar-big-01.jpg" alt="IGM-AVATAR"></a>
						</div>
				...
				<div class="col-md-8 col-lg-4 m-l-r-auto p-b-30">
					...
					<div class="blo5 pos-relative p-t-60">
						<div class="pic-blo5 size14 bo4 wrap-cir-pic hov-img-zoom ab-c-t">
							<a href="#"><img src="images/avatar/philipwalton.jpg" alt="IGM-AVATAR"></a>
						</div>
