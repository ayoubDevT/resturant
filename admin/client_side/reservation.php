<?php include 'header.php'; ?>
	...
	<!-- Title Page -->
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(images/ali-morshedlou-593422-unsplash.jpg);">
	...
	<!-- Reservation -->
	<section class="section-reservation bg3-pattern p-t-100 p-b-113">
		<div class="container">
			<div class="row">
